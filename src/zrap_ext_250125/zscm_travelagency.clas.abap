...
CLASS zscm_travelagency DEFINITION
  PUBLIC
...
CLASS zscm_travelagency IMPLEMENTATION.
  ...
  METHOD def_z_travel_agency_es_5_type.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_TRAVEL_AGENCY_ES5'
                                    is_structure              = VALUE tys_z_travel_agency_es_5_type( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_TRAVEL_AGENCY_ES5' ) ##NO_TEXT.
